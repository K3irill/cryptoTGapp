...
const NoobSlider: FunctionComponent<NoobSliderProps> = ({ onClose }) => {
	...
	const slides = [
		{
			title: 'Добро пожаловать в BIFSCOIN!',
			img: '/pugs/greet-pug.png',
			name: 'BIFSCOIN',
			text: 'BIFSCOIN (BIFS) — не просто мем, а целый космос! Наша цель — сделать криптовалюту доступной и увлекательной для каждого. Присоединяйтесь к нам и начните путешествие уже сегодня!',
		},
		{
